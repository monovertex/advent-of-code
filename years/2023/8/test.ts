...
describe('year 2023, day 8', function () {
    const input = readFile('./years/2023/8/input.txt');

    it('part 1 - example 1', function () {
        const inputExample = readFile('./years/2023/8/input-example1.txt');
        solvePart1(inputExample).toString().should.equal(answers.part1Example1.toString());
    });

    it('part 1 - example 2', function () {
        const inputExample = readFile('./years/2023/8/input-example2.txt');
        solvePart1(inputExample).toString().should.equal(answers.part1Example2.toString());
    });

    it('part 2 - example', function () {
        const inputExample = readFile('./years/2023/8/input-example3.txt');
