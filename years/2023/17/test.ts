...
describe('year 2023, day 17', function () {
    const inputExample = readFile('./years/2023/17/input-example.txt');
    const input = readFile('./years/2023/17/input.txt');
    ...
    it('part 2 - example 1', function () {
        solvePart2(readFile('./years/2023/17/input-example2.txt')).toString().should.equal(answers.part2Example2.toString());
    });
