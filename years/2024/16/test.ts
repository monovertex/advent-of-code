...
describe('year 2024, day 16', function () {
    const input = readFile('./years/2024/16/input.txt');

    it('part 1 - example 1', function () {
        const inputExample = readFile('./years/2024/16/input-example1.txt');
        solvePart1(inputExample).toString().should.equal(answers.part1Example1.toString());
    });

    it('part 1 - example 2', function () {
        const inputExample = readFile('./years/2024/16/input-example2.txt');
