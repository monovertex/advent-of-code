...
describe('year 2024, day 22', function () {
    const input = readFile('./years/2024/22/input.txt');

    it('part 1 - example', function () {
        const inputExample = readFile('./years/2024/22/input-example.txt');
    ...
    it('part 2 - example', function () {
        const inputExample = readFile('./years/2024/22/input-example2.txt');
